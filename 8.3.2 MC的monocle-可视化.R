...
getwd()
mouse_monocle <- readRDS("./data source/rds/MC时序（起点）.rds")
...
genes <- c("Klk1", "Klk1b22", "Klk1b3", "Klk1b4", "Klk1b5", "Klk1b8", 
           "Klk1b9", "Klk6", "Klk7", "Klk8", "Lif", "Lifr")
genes_exp <- list()
...
colnames(data)
data <- data %>% 
  select("group", "Pseudotime", "Klk1", "Klk1b22", "Klk1b3", "Klk1b4", 
         "Klk1b5", "Klk1b8", "Klk1b9", "Klk6", "Klk7", "Klk8", "Lif", "Lifr")
