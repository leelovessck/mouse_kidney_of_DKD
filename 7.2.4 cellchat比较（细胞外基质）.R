...
####数据准备############################
#数据准备
con.chat <- readRDS("./data source/cellchat/control（细胞外基质）.rds")
dkd.chat <- readRDS("./data source/cellchat/DKD（细胞外基质）.rds")
