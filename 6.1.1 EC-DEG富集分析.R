...
kegg <- setReadable(kegg,"org.Mm.eg.db","ENTREZID")  
  ##把ENTREZID转换为SYMBOL
write.csv(kegg@result, "2.1 全部EC的KEGG（up）.csv")
...
goMF <- enrichGO(UP.DEG_df$SYMBOL, 
                 ...
                 readable = FALSE, 
                 pool = FALSE)
write.csv(goMF@result, "2.2全部EC的GO_MF（up）.csv")
...
goCC <- enrichGO(UP.DEG_df$SYMBOL, 
                 ...
                 readable = FALSE, 
                 pool = FALSE)
write.csv(goCC@result, "2.3 全部EC的GO_CC（up）.csv")
...
goBP <- enrichGO(UP.DEG_df$SYMBOL, 
                 ...
                 readable = FALSE, 
                 pool = FALSE)
write.csv(goBP@result, "2.4 全部EC的GO_BP（up）.csv")
...
Reactome <- setReadable(Reactome,"org.Mm.eg.db","ENTREZID")  
##把ENTREZID转换为SYMBOL
write.csv(Reactome@result, "2.5 全部EC的Reactome（up）.csv")
...
kegg <- setReadable(kegg,"org.Mm.eg.db","ENTREZID")  
  ##把ENTREZID转换为SYMBOL
write.csv(kegg@result, "3.1 全部EC的KEGG（down）.csv")
...
goMF <- enrichGO(DOWN.DEG_df$SYMBOL, 
                 ...
                 readable = FALSE, 
                 pool = FALSE)
write.csv(goMF@result, "3.2 全部EC的GO_MF（down）.csv")
...
goCC <- enrichGO(DOWN.DEG_df$SYMBOL, 
                 ...
                 readable = FALSE, 
                 pool = FALSE)
write.csv(goCC@result, "3.3 全部EC的GO_CC（down）.csv")
...
goBP <- enrichGO(DOWN.DEG_df$SYMBOL, 
                 ...
                 readable = FALSE, 
                 pool = FALSE)
write.csv(goBP@result, "3.4 全部EC的GO_BP（down）.csv")
...
Reactome <- setReadable(Reactome,"org.Mm.eg.db","ENTREZID")  
##把ENTREZID转换为SYMBOL
write.csv(Reactome@result, "3.5 全部EC的Reactome（down）.csv")
