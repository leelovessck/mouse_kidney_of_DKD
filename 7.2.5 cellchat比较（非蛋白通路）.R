...
####数据准备############################
#数据准备
con.chat <- readRDS("./data source/cellchat/control（非蛋白通路）.rds")
dkd.chat <- readRDS("./data source/cellchat/DKD（非蛋白通路）.rds")
